...
namespace TheWorkBook.Utilities.CertGenerator
{
    // Reference Url: https://damienbod.com/2020/02/10/create-certificates-for-identityserver4-signing-using-net-core/
    class Program
    {
